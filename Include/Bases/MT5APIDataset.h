   ...
   enum EnFlags
     {
      ...
      //--- enumeration borders
      FLAG_ALL                =FLAG_PRIMARY|FLAG_HIDDEN|FLAG_CENTER|FLAG_SORT_DEFAULT|FLAG_INVISIBLE_DEFAULT
     };
   //--- color
   enum EnColumnColor
     {
   ...
   enum EnType
     {
      ...
      //--- enumeration borders
      TYPE_FIRST              =TYPE_INT,
      TYPE_LAST               =TYPE_VOLUME_POSITION_EXT
     };
   //--- summary flags
   enum EnFlags
     {
   ...
   enum EnFieldId
     {
      ...
      FIELD_DEAL_LAST                        =FIELD_DEAL_ACTION_GATEWAY,
      ...
      FIELD_ULTENCY_DEAL_EXTERNAL_ID         =7002,         // LPCWSTR     , deal ticket in external system 
      ...
      FIELD_ULTENCY_DEAL_LIQUIDITY_PROVIDER  =7006,         // uint32_t    , liquidity config 
      FIELD_ULTENCY_DEAL_LIQUIDITY_PROVIDER_ID=7007,        // uint64_t    , liquidity 
      ...
      FIELD_ULTENCY_DEAL_SYMBOL              =7011,         // LPCWSTR     , deal symbol 
      ...
      FIELD_ULTENCY_DEAL_LP_SYMBOL           =7018,         // LPCWSTR     , deal symbol 
      ...
      FIELD_ULTENCY_DEAL_LP_COMMISSION       =7025,         // double      , deal creation datetime in us 
      ...
      FIELD_ULTENCY_DEAL_LAST                =FIELD_ULTENCY_DEAL_RATE_USD,
      //--- enumeration borders
      FIELD_FIRST                            =FIELD_USER_FIRST,
      FIELD_LAST                             =FIELD_ULTENCY_DEAL_LAST
     };
   //--- flags
   enum EnFieldFlags
     {
