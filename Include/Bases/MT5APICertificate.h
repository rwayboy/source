...
public:
   ...
   virtual uint64_t    SerialNumber(void) const=0;
   virtual int64_t     ValidFrom(void) const=0;
   virtual int64_t     ValidTo(void) const=0;
